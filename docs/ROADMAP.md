...
на 13 августа 2026 — сделано 17 задач из 27, веха B закрыта целиком.
...
| Задача | Что это даёт |
| ------ | ------------ |
| E1–E3 | Точные лимиты подписки вместо приближения и секундная точность вместо пятисекундной: цифры идут от самого Claude Code, а не восстанавливаются по файлам |
