...
на 14 августа 2026 — сделано 30 задач из 36, вехи A, B и E закрыты целиком.
...
| E4 | Эти данные попадают туда, где на них смотрят: виджет на дашборде, строки в `cdash stats`, разделы дайджеста советчика и честный статус «ждёт разрешения» вместо догадки по процессам |
...
- [x] **E4. Применение телеметрии** — сверх плана вехи: собранные данные должны
  ...
  `http/protobuf` вместо `http/json` (иначе `cdash otel` говорил «посылок не
